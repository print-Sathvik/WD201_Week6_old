...
module.exports = (sequelize, DataTypes) => {
  class Todo extends Model {
    ...
    static async showList() {
      ...
      let overdueStr = await overdueTodos.map(todo => todo.displayableString()).join("\n");
      ...
      let dueTodayStr = await dueTodayTodos.map(todo => todo.displayableString()).join("\n");
      ...
      let dueLaterStr = await dueLaterTodos.map(todo => todo.displayableString()).join("\n");
